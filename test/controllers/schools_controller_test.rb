...
class SchoolsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create school" do
    assert_difference('School.count') do
      post schools_url, params: { school: { f_name: @school.f_name, l_name: @school.l_name } }
    end
  ...
  test "should update school" do
    patch school_url(@school), params: { school: { f_name: @school.f_name, l_name: @school.l_name } }
